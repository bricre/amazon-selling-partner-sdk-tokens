# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for Tokens 
...
```shell
composer require bricre/amazon-selling-partner-sdk-tokens
```
